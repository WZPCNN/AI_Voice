...
# create_agent — langchain 的 Agent 工厂（从 langgraph 迁移）
...
class AgentRunner:
    ...
    def _build_graph(self):
        """使用 langchain 的 create_agent 构建 ReAct 状态图。
        ...
        """
        return create_agent(self.llm, self.tools, checkpointer=self.checkpointer)
